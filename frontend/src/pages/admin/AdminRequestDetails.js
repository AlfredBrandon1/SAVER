...
const AdminRequestDetails = () => {
	...
	return (
		<div className='AdminRequestDetailsContainer'>
			...
			<h2 className='emergencyType' style={{color: '#313131'}}><strong>{currentRequest.emergencyType.toUpperCase()}</strong></h2>
			...
			<p className='admin-requestDetails'>MESSAGE: <span style={{color: '#313131'}}><strong>{currentRequest.situation.toUpperCase()}</strong></span></p>
